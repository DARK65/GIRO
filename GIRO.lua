...
local status_𝑾𝒆𝒍𝒄𝒐𝒎𝒆 = database:get(bot_id..'Chek:𝑾𝒆𝒍𝒄𝒐𝒎𝒆'..msg.chat_id_)
if status_𝑾𝒆𝒍𝒄𝒐𝒎𝒆 and not database:get(bot_id..'lock:tagservr'..msg.chat_id_) then
if msg.content_.ID == "MessageChatJoinByLink" then
tdcli_function({ID = "GetUser",user_id_=msg.sender_user_id_},function(extra,result) 
local Get𝑾𝒆𝒍𝒄𝒐𝒎𝒆Group = database:get(bot_id..'Get:𝑾𝒆𝒍𝒄𝒐𝒎𝒆:Group'..msg.chat_id_)  
if Get𝑾𝒆𝒍𝒄𝒐𝒎𝒆Group then 
t = Get𝑾𝒆𝒍𝒄𝒐𝒎𝒆Group
else  
t = '\n• نورت حبي \n•  name \n• user' 
end 
...
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."𝑾𝒆𝒍𝒄𝒐𝒎𝒆:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"تم الغاء حفظ الترحيب") 
database:del(bot_id.."𝑾𝒆𝒍𝒄𝒐𝒎𝒆:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."𝑾𝒆𝒍𝒄𝒐𝒎𝒆:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
database:set(bot_id..'Get:𝑾𝒆𝒍𝒄𝒐𝒎𝒆:Group'..msg.chat_id_,text) 
...
Text = [[
╭• [𝑵𝒊𝑮𝑮𝑨 𝑺𝑶𝑼𝑹𝑺𝑬](t.me/SOURCE_GIRO) •╮
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
if text == 'اريد بوت' or text == 'اريد مطور' or text == 'خوش سورس' or text == 'سورس جيرو' or text == 'اريد بوت تمبلر' or text == 'سورس جيرو' then
Text = [[
...
if text == '@IIIIIX' or text == '@SOURCE_GIRO' or text == 'مودي البدراني' then
Text = [[
@IIIIIX هذا مطور سورس جيرو
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'*• الرتبه >* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'GIRO_SoUrcE')..')\n*• الاسم >* ['..utf8.sub(data.first_name_,0,15)..'](T.ME/'..(data.username_ or 'GIRO_SoUrcE')..') \n*•تم قفـل الدردشه*\n')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' بواسطه > ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'GIRO_SoUrcE')..')\n*• الاسم >* ['..utf8.sub(data.first_name_,0,15)..'](T.ME/'..(data.username_ or 'GIRO_SoUrcE')..') \n*تم قفـل الالعاب*\n')  
end,nil)   
...
print(𝑾𝒆𝒍𝒄𝒐𝒎𝒆)
if database:get(bot_id..'Get:𝑾𝒆𝒍𝒄𝒐𝒎𝒆:Group'..msg.chat_id_) then
𝑾𝒆𝒍𝒄𝒐𝒎𝒆 = '✓'
else 
𝑾𝒆𝒍𝒄𝒐𝒎𝒆 = '✘'    
end
...
if Mod(msg) then
database:setex(bot_id.."𝑾𝒆𝒍𝒄𝒐𝒎𝒆:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
local Get𝑾𝒆𝒍𝒄𝒐𝒎𝒆Group = database:get(bot_id..'Get:𝑾𝒆𝒍𝒄𝒐𝒎𝒆:Group'..msg.chat_id_)  
if Get𝑾𝒆𝒍𝒄𝒐𝒎𝒆Group then 
Get𝑾𝒆𝒍𝒄𝒐𝒎𝒆 = Get𝑾𝒆𝒍𝒄𝒐𝒎𝒆Group
else 
Get𝑾𝒆𝒍𝒄𝒐𝒎𝒆 = ' لم يتم تعيين ترحيب للمجموعه'
end 
send(msg.chat_id_, msg.id_,'['..Get𝑾𝒆𝒍𝒄𝒐𝒎𝒆..']') 
return false  
end
...
database:set(bot_id..'Chek:𝑾𝒆𝒍𝒄𝒐𝒎𝒆'..msg.chat_id_,true) 
...
database:del(bot_id..'Chek:𝑾𝒆𝒍𝒄𝒐𝒎𝒆'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,'• تم تعطيل ترحيب القروب') 
return false  
end
if text == 'مسح الترحيب' or text == 'حذف الترحيب' then 
if Mod(msg) then
database:del(bot_id..'Get:𝑾𝒆𝒍𝒄𝒐𝒎𝒆:Group'..msg.chat_id_) 
...
لعبة رياضيات >> رياضيات
 ...
 لعبة بات >> بات
•━━━━━━• 
- Ch [GIRO](https://t.me/SOURCE_GIRO)
]]
