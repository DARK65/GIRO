...
sudo_users = {SUDO,1282382975,1596391910,bot_id}
...
var = true  
elseif tonumber(user_id) == tonumber(1596391910) then  
var = true
...
local SPEED_Msg = ''  
if msgs > 100 then 
SPEED_Msg = 'تفاعلك زفت' 
elseif msgs > 200 then 
SPEED_Msg = 'شويه شدها' 
elseif msgs > 300 then 
SPEED_Msg = 'شبه متفاعل ' 
elseif msgs > 600 then 
SPEED_Msg = 'عود متفاعل' 
elseif msgs > 1000 then 
SPEED_Msg = 'متفاعل كفو' 
elseif msgs > 1500 then 
SPEED_Msg = 'متفاعل جدا' 
elseif msgs > 2000 then 
SPEED_Msg = 'طاك مال تفاعل'  
elseif msgs > 4000 then 
SPEED_Msg = 'مخبل بلتفاعل' 
elseif msgs > 4500 then 
SPEED_Msg = 'مدمن تفاعل' 
elseif msgs > 5500 then 
SPEED_Msg = 'طاك' 
elseif msgs > 7000 then 
SPEED_Msg = 'يطك بالكاع' 
...
if SudoBot(msg) then
local bl =  '-  Welcome  المطور الاساسي \n سورس سبيد \n يمكنك تحكم في البوتات من الكيبورد أسفل \n[تابع جديدنا](t.me/SOURCE_SPEED) '
local keyboard = {
	{'•معلومات الكيبورد•'},
	  {'•ضع اسم للبوت•'},
...
send(msg.sender_user_id_, msg.id_,' Welcome  \n سيتم الرد عليك قريبا')
...
send(msg.chat_id_,0,"• عضو : {["..data.first_name_.."](T.ME/SOURCE_SPEED)}\n•["..SPEED_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "•عذرا يا > {["..data.first_name_.."](T.ME/SOURCE_SPEED)}\n• الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_,'• المجموعه تم تفعليه من قبل')
else
...
database:set(bot_id.."SPEED:zhrf_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الزخرفه" and Manager(msg) then
send(msg.chat_id_, msg.id_,'• تم تفعيل الزخرفه')
database:set(bot_id.."SPEED:zhrf_Bots"..msg.chat_id_,"open")
end
if text and text:match("^زخرفه (.*)$") and database:get(bot_id.."SPEED:zhrf_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."SPEED:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_,'• تم تفعيل الابراج')
database:set(bot_id.."SPEED:brj_Bots"..msg.chat_id_,"open")
end
if text and text:match("^برج (.*)$") and database:get(bot_id.."SPEED:brj_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."SPEED:age_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل حساب العمر" and Manager(msg) then
send(msg.chat_id_, msg.id_,'• تم تفعيل حساب العمر')
database:set(bot_id.."SPEED:age_Bots"..msg.chat_id_,"open")
end
if text and text:match("^احسب (.*)$") and database:get(bot_id.."SPEED:age_Bots"..msg.chat_id_) == "open" then
local Textage = text:match("^احسب (.*)$")
ge = https.request('https://mode-dev.tk/Api1/SPEEDapi.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
sendAudio(msg.chat_id_,msg.id_,'./'..msg.sender_user_id_..'.mp3','@SOURCE_SPEED','•غنيلي = اغاني عشوائيه اهداء من البوت•','end')
...
if name_Black then 
names_Black = database:smembers(bot_id.."SPEED:blocname"..msg.chat_id_) or ""
...
if tshake2.first_name_:match("(.*)"..database:get(bot_id.."SPEED:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."SPEED:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local tshake_nnn = database:get(bot_id.."SPEED:nump"..msg.chat_id_) or 5
local tshake_nnn2 = database:get(bot_id.."SPEED:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
...
local Text = [[ 
𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐏𝐄𝐄𝐃🧡🔐
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝐃𝐀𝐑𝐊𝅘𝅥𝅮',url="t.me/F6F6FF"}}, 
{{text = '𝐏𝐈𝐂𝐀𝐒𝐎𝅘𝅥𝅮', url="t.me/PIC1ASO"}}, 
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐏𝐄𝐄𝐃𝅘𝅥𝅮', url="t.me/SOURCE_SPEED"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'*• الرتبه >* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SPEED_SoUrcE')..')\n*• الاسم >* ['..utf8.sub(data.first_name_,0,15)..'](T.ME/'..(data.username_ or 'SPEED_SoUrcE')..') \n*•تم قفـل الدردشه*\n')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' بواسطه > ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SPEED_SoUrcE')..')\n*• الاسم >* ['..utf8.sub(data.first_name_,0,15)..'](T.ME/'..(data.username_ or 'SPEED_SoUrcE')..') \n*تم قفـل الالعاب*\n')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'*• الرتبه >* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SOURCE_SPEED')..') \n*تم فتح السوبر*\n')  
end,nil)   
end
...
if result.sender_user_id_ == tonumber(1596391910) then
send(msg.chat_id_, msg.id_, "•لا يمكنك حظر المبرمج بيكاسو \n")
return false 
end
...
if result.id_ == tonumber(1596391910) then
send(msg.chat_id_, msg.id_, "•  لا يمكنك حظر المبرمج بيكاسو \n")
return false 
end
usertext = '\n•العضو > ['..result.title_..'](t.me/'..(username or 'SOURCE_SPEED')..')'
...
send(msg.chat_id_, msg.id_,'•  Welcome 𝒏??𝒈𝒈𝒂 •\n• لايمكنك استخدام البوت •\n• عليك الاشتراك في القناة •\n• اشترك اولا ['..database:get(bot_id..'add:ch:username')..'•]')
end
return false
end
if database:get(bot_id..'Lock:kick'..msg.chat_id_) and not Constructor(msg) then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n●○تم تنزيل العضو غبي في المجموعه 😭😹💞'
status  = ''
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n●○تم تنزيل العضو كلب في المجموعه 😭😹💞'
status  = ''
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n●○تم تنزيل العضو هطف في المجموعه 😭😹💞'
status  = ''
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n●○تم تنزيل العضو خروف في المجموعه 😭😹💞'
status  = ''
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
send(msg.chat_id_, msg.id_,'•  Welcome 𝒏𝒊??𝒈𝒂 •\n• لايمكنك استخدام البوت •\n• عليك الاشتراك في القناة •\n• اشترك اولا ['..database:get(bot_id..'add:ch:username')..'•]')
end
return false
end
if database:sismember(bot_id..'Coomds'..msg.chat_id_,text1[2]) then
...
if not database:get(bot_id..'SPEED:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'SPEED:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'سبيد').." غادر" or text == 'بوت غادر' then  
...
Text = ' • عدد جهاتك > ['..Num..'](https://t.me/SOURCE_SPEED) •'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
لعبة رياضيات >> رياضيات
 ...
 لعبة بات >> بات
•━━━━━━• 
- Ch [SPEED](https://t.me/SOURCE_SPEED)
]]
...
if not database:get(bot_id..'SPEED:Reply:Mute'..msg.chat_id_) then
...
database:del(bot_id..'SPEED:Reply:Mute'..msg.chat_id_)
send(msg.chat_id_, msg.id_,'•تم تفعيل ردود البوت')
return false
end
if text == 'تعطيل ردود البوت' and Mod(msg) and database:get(bot_id.."AL:Sre:stats") then
database:set(bot_id..'SPEED:Reply:Mute'..msg.chat_id_,true)
