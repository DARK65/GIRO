...
sudo_users = {SUDO,1282382975,bot_id}
...
send(msg.chat_id_, msg.id_,'• عدد القروبات الان > { '..#group..' }'..SPEEDk..''..SPEED..'\n*• الان عدد القروبات الحقيقي > { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
Text = [[
╭• [𝑵𝒊𝑮𝑮𝑨 𝑺𝑶𝑼𝑹𝑺𝑬](t.me/SOURCE_SPEED) •╮
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
if text == 'اريد بوت' or text == 'اريد مطور' or text == 'خوش سورس' or text == 'سورس سبيد' or text == 'اريد بوت تمبلر' or text == 'سورس سبيد' then
Text = [[
...
if text == '@IIIIIX' or text == '@SOURCE_SPEED' or text == 'مودي البدراني' then
Text = [[
@IIIIIX هذا مطور سورس سبيد
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
